...
from fairspec_table.plugins.sqlite.actions.column.to_database import convert_column_to_database
...
def convert_table_schema_to_database(
    ...
    for column in columns:
        is_nullable = column.nullable if column.nullable is not None else not column.required
