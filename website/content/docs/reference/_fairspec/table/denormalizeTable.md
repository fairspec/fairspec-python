...
next: false
prev: false
title: "denormalizeTable"
---

> **denormalizeTable**(`table`, `tableSchema`, `options?`): `Promise`\<`LazyDataFrame`\<`any`\>\>

Defined in: [table/actions/table/denormalize.ts:13](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/table/actions/table/denormalize.ts#L13)
