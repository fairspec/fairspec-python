...
> **loadXlsxTable**(`resource`, `options?`): `Promise`\<`LazyDataFrame`\<`any`\>\>

Defined in: [table/plugins/xlxs/actions/table/load.ts:16](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/table/plugins/xlxs/actions/table/load.ts#L16)
