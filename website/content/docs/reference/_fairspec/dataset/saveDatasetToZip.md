...
next: false
prev: false
title: "saveDatasetToZip"
---

> **saveDatasetToZip**(`dataset`, `options`): `Promise`\<`void`\>

Defined in: [dataset/plugins/zip/actions/dataset/save.ts:12](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/dataset/plugins/zip/actions/dataset/save.ts#L12)
