...
next: false
prev: false
title: "inferIntegrity"
---

> **inferIntegrity**(`resource`, `options?`): `Promise`\<`undefined` \| \{ `hash`: `string`; `type`: `"md5"` \| `"sha1"` \| `"sha256"` \| `"sha512"`; \}\>

Defined in: [dataset/actions/file/infer.ts:44](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/dataset/actions/file/infer.ts#L44)
...
`Promise`\<`undefined` \| \{ `hash`: `string`; `type`: `"md5"` \| `"sha1"` \| `"sha256"` \| `"sha512"`; \}\>
