...
next: false
prev: false
title: "saveDatasetToCkan"
---

> **saveDatasetToCkan**(`dataset`, `options`): `Promise`\<\{ `datasetUrl`: `string`; `path`: `unknown`; \}\>

Defined in: [dataset/plugins/ckan/actions/dataset/save.ts:16](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/dataset/plugins/ckan/actions/dataset/save.ts#L16)
