...
> **inferTextual**(`resource`, `options?`): `Promise`\<`boolean`\>

Defined in: [dataset/actions/file/infer.ts:15](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/dataset/actions/file/infer.ts#L15)
