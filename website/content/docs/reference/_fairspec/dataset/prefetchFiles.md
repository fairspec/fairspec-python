...
> **prefetchFiles**(`resource`): `Promise`\<`string`[]\>

Defined in: [dataset/actions/file/fetch.ts:8](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/dataset/actions/file/fetch.ts#L8)
