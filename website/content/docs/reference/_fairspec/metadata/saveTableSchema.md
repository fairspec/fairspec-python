...
next: false
prev: false
title: "saveTableSchema"
---

> **saveTableSchema**(`tableSchema`, `options`): `Promise`\<`void`\>

Defined in: [metadata/actions/tableSchema/save.ts:10](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/metadata/actions/tableSchema/save.ts#L10)
