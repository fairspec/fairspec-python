...
next: false
prev: false
title: "inferFormatName"
---

> **inferFormatName**(`resource`): `undefined` \| `"csv"` \| `"tsv"` \| `"json"` \| `"jsonl"` \| `"xlsx"` \| `"ods"` \| `"sqlite"` \| `"parquet"` \| `"arrow"`

Defined in: [metadata/actions/format/infer.ts:6](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/metadata/actions/format/infer.ts#L6)
...
`undefined` \| `"csv"` \| `"tsv"` \| `"json"` \| `"jsonl"` \| `"xlsx"` \| `"ods"` \| `"sqlite"` \| `"parquet"` \| `"arrow"`
