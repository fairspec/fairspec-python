...
next: false
prev: false
title: "getDataRecords"
---

> **getDataRecords**(`resource`): `undefined` \| `Record`\<`string`, `unknown`\>[]

Defined in: [metadata/actions/resource/data.ts:29](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/metadata/actions/resource/data.ts#L29)
