...
next: false
prev: false
title: "inferDataSchema"
---

> **inferDataSchema**(`resource`): `Promise`\<`undefined` \| `Record`\<`string`, `unknown`\>\>

Defined in: [library/actions/dataSchema/infer.ts:5](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/library/actions/dataSchema/infer.ts#L5)
