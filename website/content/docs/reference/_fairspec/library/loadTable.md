...
> **loadTable**(`resource`, `options?`): `Promise`\<`undefined` \| [`Table`](/reference/_fairspec/library/table/)\>

Defined in: [library/actions/table/load.ts:5](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/library/actions/table/load.ts#L5)
