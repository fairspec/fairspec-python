...
next: false
prev: false
title: "renderTableSchemaAs"
---

> **renderTableSchemaAs**(`tableSchema`, `options`): `Promise`\<`string`\>

Defined in: [library/actions/tableSchema/render.ts:4](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/library/actions/tableSchema/render.ts#L4)
