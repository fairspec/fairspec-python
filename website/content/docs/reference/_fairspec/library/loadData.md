...
> **loadData**(`resource`): `Promise`\<`undefined` \| `Record`\<`string`, `unknown`\>[] \| `Record`\<`string`, `any`\>\>

Defined in: [library/actions/data/load.ts:5](https://github.com/fairspec/fairspec-typescript/blob/803775fa64a99d4fa42ce85a2ad241f930b9f96a/library/actions/data/load.ts#L5)
...
`Promise`\<`undefined` \| `Record`\<`string`, `unknown`\>[] \| `Record`\<`string`, `any`\>\>
