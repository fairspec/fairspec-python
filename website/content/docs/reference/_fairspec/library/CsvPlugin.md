...
Defined in: table/build/plugins/csv/plugin.d.ts:4
...
[`TablePlugin`](/reference/_fairspec/library/tableplugin/).[`inferFormat`](/reference/_fairspec/library/tableplugin/#inferformat)
...
[`TablePlugin`](/reference/_fairspec/library/tableplugin/).[`loadTable`](/reference/_fairspec/library/tableplugin/#loadtable)
...
[`TablePlugin`](/reference/_fairspec/library/tableplugin/).[`saveTable`](/reference/_fairspec/library/tableplugin/#savetable)
