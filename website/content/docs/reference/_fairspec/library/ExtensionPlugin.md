...
next: false
prev: false
title: "ExtensionPlugin"
---

Defined in: extension/build/plugin.d.ts:2
...
> **new ExtensionPlugin**(): `ExtensionPlugin`
...
> **renderTableSchemaAs**(`tableSchema`, `options`): `undefined` \| `string`

Defined in: extension/build/plugin.d.ts:3
